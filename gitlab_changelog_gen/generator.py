...
'''
    ...
    def generate(self):
        ...
        mrs = g_project.mergerequests.list(state='merged', query_parameters={'per_page':1000000000}, order_by='created_at', sort='asc')
        print("mr's: " + str(len(mrs)))
        for m in mrs:
            print(m)
